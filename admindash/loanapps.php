<?php
@include('connect.php');
$select = "SELECT * FROM loanapplications";
...
if (isset($_GET['type']) && $_GET['type'] != '') {
  ...
  if ($type == 'status') {
    ...
    $update_status_sql = "update loanapplications set status='$status' where id='$id'";
  ...
  if ($type == 'delete') {
    $id = $_GET['id'];
    $delete_sql = "delete from loanapplications where id='$id'";
                ...
                <tbody>
                  <?php while ($row = mysqli_fetch_array($result)) { ?>
                    <tr>
                      ...
                      <td><?php echo $row['benefactorphone'] ?></td>
